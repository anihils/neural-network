`neural_network.ipynb` contains a classifier using a full connected three layer neural network with logistic activation functions. Classifier is trained using schotastic gradient descent.
